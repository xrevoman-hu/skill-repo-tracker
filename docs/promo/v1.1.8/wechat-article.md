...
![Skill Repo Tracker 产品 Logo](product-logo.png)
...
下面的界面图都来自 v1.1.8 实机截图；手绘图只用来解释产品价值和使用场景。
...
2. 双击打开 DMG，把 `Skill Repo Tracker.app` 拖到 `/Applications`。
3. 第一次启动如果 macOS 提示“无法验证开发者”，在 Finder 里右键 App，选择“打开”，再确认“打开”。
4. 如果右键打开仍被拦截，去“系统设置 -> 隐私与安全性”，在页面底部点“仍要打开”。
5. 技术用户可以执行 `xattr -cr "/Applications/Skill Repo Tracker.app"` 清除下载隔离属性。
