-- Fictional, sanitized v1.1.12 core fixture reconstructed from the published tag DDL.
-- No Keychain secret, prompt body, user path, or real account data is present.
PRAGMA foreign_keys = ON;
PRAGMA user_version = 0;

CREATE TABLE repositories (
  id TEXT PRIMARY KEY, name TEXT NOT NULL, owner TEXT NOT NULL, repo TEXT NOT NULL,
  ref_name TEXT NOT NULL, repo_type TEXT NOT NULL, skills_count INTEGER NOT NULL DEFAULT 0,
  remote_sha TEXT NOT NULL DEFAULT 'unknown', last_backup_sha TEXT, last_checked TEXT,
  backup_status TEXT NOT NULL DEFAULT 'never-backed-up', check_status TEXT NOT NULL DEFAULT 'unknown',
  url TEXT NOT NULL, branch TEXT NOT NULL, backup_path TEXT, snapshot_time TEXT,
  source_type TEXT NOT NULL DEFAULT 'github', local_path TEXT, github_account_id TEXT,
  canonical_name TEXT, error TEXT, readme_search_text TEXT NOT NULL DEFAULT '',
...
CREATE TABLE user_notes (
  scope TEXT NOT NULL, entity_key TEXT NOT NULL, note TEXT NOT NULL DEFAULT '',
  updated_at TEXT NOT NULL, PRIMARY KEY(scope, entity_key)
);
...
INSERT INTO settings VALUES
  ('fixture_version', 'v1.1.12'), ('concurrency', '7'),
  ('retry_count', '3'), ('cleanup_keep', '42');
...
INSERT INTO github_repo_catalog
  (account_id, full_name, owner, repo, html_url, description, default_branch, starred,
   permissions, readme_search_text, last_refreshed)
VALUES ('github:fixture-account', 'fixture/repository', 'fixture', 'repository',
  ...
  'push,pull', 'fictional catalog search', '2026-01-01T00:00:00Z');
INSERT INTO repositories VALUES (
  'github:fixture/repository:main', 'Fixture Repository', 'fixture', 'repository', 'main',
  'skill repo', 1, 'fixture-remote-sha', 'fixture-backup-sha', '2026-01-01T00:00:00Z',
  'backed-up-latest', 'success', 'https://github.com/fixture/repository', 'main',
  '/tmp/fictional-backup/repository.zip', '2026-01-01T00:00:00Z', 'github', NULL,
  'github:fixture-account', 'fixture/repository', NULL, '',
  '2026-01-01T00:00:00Z', '2026-01-01T00:00:00Z'
);
INSERT INTO skills
  (id, repo_id, name, description, repo_name, path, ref_name, remote_version, status,
   installed, remote_hash, source_type, search_text, created_at, updated_at)
...
INSERT INTO plugins
  (id, repo_id, name, description, kind, install_command, update_command, source_path,
   source_excerpt, status, detected_sha, created_at, updated_at, search_text)
...
INSERT INTO user_notes VALUES
  ('repository', 'github:fixture/repository', 'fictional compatibility note',
   '2026-01-01T00:00:00Z');
