...
- `src-tauri/target/release/bundle/dmg/Skill Repo Tracker_1.1.11_*.dmg`
...
codesign --force --sign - "src-tauri/target/release/bundle/dmg/Skill Repo Tracker_1.1.11_aarch64.dmg"
```
...
1. 从 GitHub Release 下载 `Skill.Repo.Tracker_1.1.11_aarch64.dmg`。
...
1. Download `Skill.Repo.Tracker_1.1.11_aarch64.dmg` from GitHub Releases.
